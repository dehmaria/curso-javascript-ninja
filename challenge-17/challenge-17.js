(function(){
	...
	*/
	...
	var newText = text.replace(/Manuel Marques de Sousa/, 'Deborah Campos');
	console.log(newText);
	/*
	...
	*/
	...
	var newCity = text.replace(/brasileiro/g, 'paulista');
	console.log(newCity);
	...
	*/
	...
	var newNumber = text.replace(/\d/g,'-');
	...
	*/
	...
	var newLetter = text.replace(/[D-Za-h]/g, '0');
	...
	*/
	...
	var newWord = text.replace(/(a)/gi, '4');
	console.log(newWord);
	...
	*/
	...
	var newNickname = text.replace(/O Centauro de Luvas/, function(nickname){
	...
	*/
	...
	var regexDate = /(\d\d) de (\w*) de (\d\d\d\d)/g;
